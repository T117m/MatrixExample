...
## Результат
Короче, _распараллелизованная_ ```InverseProduct``` в среднем на ~10 780,75 ns/op быстрее чем последовательная альтернатива. А ещё я ненавижу работать с матрицами теперь.
