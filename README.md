...
## Результат
Короче, _распараллелизованная_ ```InverseProduct``` в среднем на ~10 780,75 ns/op быстрее чем последовательная альтернатива. Больше никаких значительных различий между ними нет. Теперь я ненавижу работать с матрицами. Спасибо за внимание.
